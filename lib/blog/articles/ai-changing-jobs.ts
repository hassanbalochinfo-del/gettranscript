...
export const aiChangingJobsPost: BlogPost = {
  ...
  thumbnailAlt: "University students studying together, representing graduates entering a changing job market",
  html: `
    ...
    <figure>
      <img
        ...
        alt="University students studying together, representing graduates entering a changing job market"
        loading="lazy"
        width="1400"
        height="933"
      />
      <figcaption>Photo: <a href="https://unsplash.com/@priscilladupreez" rel="noopener noreferrer" target="_blank">Priscilla Du Preez</a> / Unsplash</figcaption>
    </figure>
    ...
    <figure>
      <img
        ...
        alt="Modern office workspace representing corporate hiring and workplace change"
        loading="lazy"
        width="1400"
        height="933"
      />
      <figcaption>Photo: <a href="https://unsplash.com/@anniespratt" rel="noopener noreferrer" target="_blank">Annie Spratt</a> / Unsplash</figcaption>
    </figure>
    ...
    <figure>
      <img
        ...
        alt="Person working on a laptop using AI tools for productivity and independent work"
        loading="lazy"
        width="1400"
        height="933"
      />
    ...
    <figure>
      <img
        ...
        alt="Diverse team collaborating in a meeting, highlighting human connection and leadership"
        loading="lazy"
        width="1400"
        height="933"
      />
    ...
    <figure>
      <img
        ...
        alt="Artificial intelligence concept representing the future of work and technology"
        loading="lazy"
        width="1400"
        height="933"
      />
