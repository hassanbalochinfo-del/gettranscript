  ...
  html: `
    ...
    <figure>
      <img
        ...
        alt="Person scrolling on a smartphone during a quiet moment of downtime"
        loading="lazy"
        width="1400"
        height="933"
      />
    ...
    <div class="not-prose my-10 flex flex-wrap items-center justify-center gap-8 rounded-xl border border-border bg-muted/40 p-6">
      <div class="flex flex-col items-center gap-2 text-center">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.517.0/icons/smartphone.svg" alt="" width="40" height="40" class="opacity-80" loading="lazy" />
        <span class="text-xs text-muted-foreground">Instant distraction</span>
      </div>
      <div class="flex flex-col items-center gap-2 text-center">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.517.0/icons/brain.svg" alt="" width="40" height="40" class="opacity-80" loading="lazy" />
        <span class="text-xs text-muted-foreground">Default mode network</span>
      </div>
      <div class="flex flex-col items-center gap-2 text-center">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.517.0/icons/cloud-off.svg" alt="" width="40" height="40" class="opacity-80" loading="lazy" />
        <span class="text-xs text-muted-foreground">Silence &amp; reflection</span>
      </div>
    </div>
    ...
    <figure>
      <img
        ...
        alt="Person sitting alone in thought during a quiet reflective moment"
        loading="lazy"
        width="1400"
        height="933"
      />
    ...
    <div class="not-prose my-10 grid gap-4 sm:grid-cols-3">
      <div class="flex flex-col items-center gap-2 rounded-xl border border-border bg-muted/40 p-5 text-center">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.517.0/icons/bell.svg" alt="" width="36" height="36" class="opacity-80" loading="lazy" />
        <span class="text-sm font-medium">Notifications</span>
      </div>
      <div class="flex flex-col items-center gap-2 rounded-xl border border-border bg-muted/40 p-5 text-center">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.517.0/icons/infinity.svg" alt="" width="36" height="36" class="opacity-80" loading="lazy" />
        <span class="text-sm font-medium">Endless scrolling</span>
      </div>
      <div class="flex flex-col items-center gap-2 rounded-xl border border-border bg-muted/40 p-5 text-center">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.517.0/icons/heart-crack.svg" alt="" width="36" height="36" class="opacity-80" loading="lazy" />
        <span class="text-sm font-medium">Emotional emptiness</span>
      </div>
    </div>
    ...
    <figure>
      <img
        ...
        alt="Social media and video apps on a phone screen representing constant digital stimulation"
        loading="lazy"
        width="1400"
        height="933"
      />
    ...
    <div class="not-prose my-10 grid grid-cols-2 gap-4 sm:grid-cols-4">
      <div class="flex flex-col items-center gap-2 rounded-xl border border-border bg-muted/40 p-4 text-center">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.517.0/icons/footprints.svg" alt="" width="32" height="32" class="opacity-80" loading="lazy" />
        <span class="text-xs text-muted-foreground">Walk without music</span>
      </div>
      <div class="flex flex-col items-center gap-2 rounded-xl border border-border bg-muted/40 p-4 text-center">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.517.0/icons/utensils.svg" alt="" width="32" height="32" class="opacity-80" loading="lazy" />
        <span class="text-xs text-muted-foreground">Phone-free meals</span>
      </div>
      <div class="flex flex-col items-center gap-2 rounded-xl border border-border bg-muted/40 p-4 text-center">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.517.0/icons/moon.svg" alt="" width="32" height="32" class="opacity-80" loading="lazy" />
        <span class="text-xs text-muted-foreground">No-phone evenings</span>
      </div>
      <div class="flex flex-col items-center gap-2 rounded-xl border border-border bg-muted/40 p-4 text-center">
        <img src="https://cdn.jsdelivr.net/npm/lucide-static@0.517.0/icons/users.svg" alt="" width="32" height="32" class="opacity-80" loading="lazy" />
        <span class="text-xs text-muted-foreground">Present with family</span>
      </div>
    </div>
    ...
    <figure>
      <img
        ...
        alt="Peaceful mountain landscape during a quiet walk without digital distractions"
        loading="lazy"
        width="1400"
        height="933"
      />
      <figcaption>Photo: <a href="https://unsplash.com/@sotti" rel="noopener noreferrer" target="_blank">Shifaaz shamoon</a> / Unsplash</figcaption>
    </figure>
    ...
    <figure>
      <img
        ...
        alt="Person meditating in a calm setting representing mindfulness and mental stillness"
        loading="lazy"
        width="1400"
        height="933"
      />
      <figcaption>Photo: <a href="https://unsplash.com/@madisonyen" rel="noopener noreferrer" target="_blank">Madison Yen</a> / Unsplash</figcaption>
    </figure>
  `,
}
